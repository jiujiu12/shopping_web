...
(/** @lends <global> */function( $ ) {
	 ...
	 *    the paging is reset to the first pages
	 *  @memberof DataTable#oApi
	 */
	...
	/**
	 * Add the options to the pages HTML for the table
	 *  @param {object} oSettings dataTables settings object
	 *  @memberof DataTable#oApi
	 */
	 ...
	 *  @param {array} json.aaData The data to display on this pages
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		if ( (tableWidthAttr || scrollX) && ! oSettings._reszEvt ) {
			...
			// IE6/7 will crash if we bind a resize event handler on pages load.
	...
	function _fnLengthOverflow ( settings )
	{
		...
		// Keep the start record on the current pages
		start -= (start % len);
	...
	DataTable = function( options )
	{
		 ...
		 * on display on the pages, with the HTML contents that is passed into the
		 ...
		 * previous, first or last pages-houtai.
	 ...
	 * table, all tables on a pages or a sub-set thereof.
	 *
	 ...
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'pages()', function ( action ) {
		if ( action === undefined ) {
	 ...
	 *  * `pages-houtai` - Total number of pages-houtai
	 ...
	 *    are applied.
	 */
	_api_register( 'pages.info()', function ( action ) {
	 ...
	 *   are to be shown.
	 *//**
	 * Set the current pages length.
	 *
	 * @param {integer} Page length to set. Use `-1` to show all records.
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'pages.len()', function ( len ) {
	...
	var _selector_row_indexes = function ( settings, opts )
	{
		...
		if ( _fnDataSource( settings ) == 'ssp' ) {
			...
			// Current pages implies that order=current and fitler=applied, since it is
	 ...
	 * created for the tables on a given pages.
	 *
	...
	DataTable.defaults = {
		 ...
		 * about the data that is currently visible on the pages, including information
		...
		/**
		 * Allows the end user to select the size of a formatted pages from a select
		 ...
		 * the pages the display display will match what thy had previously set up.
		 *
		 ...
		 *    process that will draw the data on the pages.
		 *  @param {object} settings DataTables settings object
		 *
		 *  @dtopt Callbacks
		 *  @dtopt Server-side
		...
		/**
		 * Number of rows to display on a single pages when using pagination. If
		...
		"oLanguage": {
			 ...
			 * actually visible on the pages, but will be read by screenreaders, and thus
			 ...
			 * * `\_PAGES\_` - Total number of pages-houtai of data in the table
			 *
			 *  @type string
			 ...
			 * However, multiple different tables on the pages can use different
		 ...
		 * DOM you want DataTables to inject the various controls it adds to the pages
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			 ...
			 * needed by a driven pages draw. This can give a significant speed
			...
			/**
			 * Present a user control allowing the end user to change the pages size
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} pages-houtai` The number of pages-houtai in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( pages, pages-houtai ) {
	...
	/**
	 * Draw event, fired whenever the table is redrawn on the pages, at the same
